...
var my_components = (function (exports) {
	...
	function add_css(target) {
		append_styles(target, "svelte-179heku", ":host{--calendar-active-text-color:#555;--calendar-inactive-text-color:#aaa;--calendar-background-color:#fff;--calendar-border-color:#ddd;--calendar-hover-border-color:#a57070}[data-theme=dark].svelte-179heku.svelte-179heku{--calendar-active-text-color:#fff;--calendar-inactive-text-color:#aaa;--calendar-background-color:#555;--calendar-border-color:#666;--calendar-hover-border-color:#a57070}div.svelte-179heku.svelte-179heku,ul.svelte-179heku.svelte-179heku,li.svelte-179heku.svelte-179heku{padding:0;margin:0}select.svelte-179heku.svelte-179heku{display:inline-block;width:auto;font-size:1rem;color:var(--calendar-active-text-color);background-color:var(--calendar-background-color)}select.svelte-179heku.svelte-179heku:hover{border-color:var(--calendar-active-text-color)}div.calendar-container.svelte-179heku.svelte-179heku{display:flex;flex-direction:column;justify-content:flex-start;align-items:flex-start;width:100%;min-width:15rem;height:100%;overflow:auto}div.calendar-controls.svelte-179heku.svelte-179heku{display:initial;white-space:nowrap;width:100%}div.calendar-view.svelte-179heku.svelte-179heku{display:flex;flex-direction:column;width:100%;height:100%}ul.calendar-weekdays.svelte-179heku.svelte-179heku{display:flex;flex-direction:row;justify-content:center;width:100%;height:3rem;list-style:none}ul.calendar-weekdays.svelte-179heku li.svelte-179heku{display:flex;flex-direction:row;justify-content:center;align-items:center;width:100%;height:100%;font-size:1rem;font-weight:bold}ul.calendar-days.svelte-179heku.svelte-179heku{display:flex;flex-direction:row;flex-wrap:wrap;justify-content:center;width:100%;height:calc(100% - 3.5rem);list-style:none}ul.calendar-days.svelte-179heku li.svelte-179heku{display:flex;flex-direction:row;justify-content:center;align-items:center;width:14.2857142857%}ul.calendar-days.svelte-179heku li div.svelte-179heku{display:inline-flex;flex-direction:column;justify-content:flex-start;align-items:center;width:100%;height:calc(100% - 0.15rem);border:0.01rem solid var(--calendar-border-color);margin:0.03rem;font-size:1.5rem}ul.calendar-days.svelte-179heku li div span.calendar-day-num.svelte-179heku{width:100%;align-self:normal;text-align:right;font-size:1rem}ul.calendar-days.svelte-179heku li div span.calendar-day-event.svelte-179heku{width:100%;align-self:normal;color:#fff;background-color:#d17bc8;text-align:left;font-size:0.8rem}ul.calendar-days.svelte-179heku li:hover div.svelte-179heku{border-color:var(--calendar-hover-border-color) !important}ul.calendar-days.svelte-179heku li.current-month.svelte-179heku{color:var(--calendar-active-text-color);background-color:var(--calendar-background-color);height:auto}ul.calendar-days.svelte-179heku li.current-month span.calendar-day-num.saturday.svelte-179heku{color:#144}ul.calendar-days.svelte-179heku li.current-month span.calendar-day-num.sunday.svelte-179heku{color:#c03}ul.calendar-days.svelte-179heku li.other-month.svelte-179heku{color:var(--calendar-inactive-text-color);background-color:var(--calendar-background-color);height:auto}ul.calendar-days.svelte-179heku li.other-month span.calendar-day-num.saturday.svelte-179heku{color:#6bf}ul.calendar-days.svelte-179heku li.other-month span.calendar-day-num.sunday.svelte-179heku{color:#fa3}ul.calendar-days.svelte-179heku li.today.svelte-179heku{background-color:#f99}\n/*# sourceMappingURL=data:application/json;charset=utf-8;base64, */");
	}
	...
	// (158:12) {#each calendarData.years as year}
	function create_each_block_3(ctx) {
		...
		const block = {
			c: function create() {
				...
				add_location(option, file, 158, 16, 5001);
			},
			m: function mount(target, anchor) {
		...
		dispatch_dev("SvelteRegisterBlock", {
			...
			type: "each",
			source: "(158:12) {#each calendarData.years as year}",
			ctx
		});
	...
	// (170:12) {#each calendarData.months as month}
	function create_each_block_2(ctx) {
		...
		const block = {
			c: function create() {
				...
				set_input_value(option, option.__value);
				add_location(option, file, 170, 16, 5387);
			},
			m: function mount(target, anchor) {
				insert_dev(target, option, anchor);
				append_dev(option, t);
		...
		dispatch_dev("SvelteRegisterBlock", {
			...
			type: "each",
			source: "(170:12) {#each calendarData.months as month}",
			ctx
		});
	...
	// (182:12) {#each calendarData.weekNames as weekName}
	function create_each_block_1(ctx) {
		...
		const block = {
			c: function create() {
				li = element("li");
				t = text(t_value);
				attr_dev(li, "class", "svelte-179heku");
				add_location(li, file, 182, 16, 5825);
			},
			m: function mount(target, anchor) {
		...
		dispatch_dev("SvelteRegisterBlock", {
			...
			type: "each",
			source: "(182:12) {#each calendarData.weekNames as weekName}",
			ctx
		});
	...
	// (187:12) {#each calendarData.days as day}
	function create_each_block(ctx) {
		...
		const block = {
			c: function create() {
				...
				t3 = space();
				attr_dev(span0, "class", "calendar-day-num svelte-179heku");
				toggle_class(span0, "saturday", /*day*/ ctx[20].dayOfWeek == 6);
				toggle_class(span0, "sunday", /*day*/ ctx[20].dayOfWeek == 0);
				add_location(span0, file, 194, 24, 6298);
				attr_dev(span1, "class", "calendar-day-event svelte-179heku");
				set_style(span1, "color", "#737");
				set_style(span1, "background-color", "#9cf");
				add_location(span1, file, 201, 24, 6610);
				attr_dev(div, "class", "calendar-day-container svelte-179heku");
				add_location(div, file, 193, 20, 6236);
				attr_dev(li, "class", "calendar-day svelte-179heku");
				...
				add_location(li, file, 187, 16, 5980);
			},
			m: function mount(target, anchor) {
				insert_dev(target, li, anchor);
				append_dev(li, div);
		...
		dispatch_dev("SvelteRegisterBlock", {
			...
			type: "each",
			source: "(187:12) {#each calendarData.days as day}",
			ctx
		});
	...
	function create_fragment(ctx) {
		...
		const block = {
			c: function create() {
				...
				add_location(link, file, 148, 4, 4619);
				attr_dev(select0, "name", "calendar-selector-year");
				attr_dev(select0, "aria-label", "Year");
				attr_dev(select0, "class", "svelte-179heku");
				if (/*calendarData*/ ctx[3].selectedYear === void 0) add_render_callback(() => /*select0_change_handler*/ ctx[11].call(select0));
				add_location(select0, file, 150, 8, 4709);
				attr_dev(select1, "name", "calendar-selector-month");
				attr_dev(select1, "aria-label", "Month");
				attr_dev(select1, "class", "svelte-179heku");
				if (/*calendarData*/ ctx[3].selectedMonth === void 0) add_render_callback(() => /*select1_change_handler*/ ctx[13].call(select1));
				add_location(select1, file, 162, 8, 5089);
				add_location(button0, file, 174, 8, 5477);
				add_location(button1, file, 175, 8, 5538);
				add_location(button2, file, 176, 8, 5610);
				attr_dev(div0, "class", "calendar-controls svelte-179heku");
				add_location(div0, file, 149, 4, 4668);
				attr_dev(ul0, "class", "calendar-weekdays svelte-179heku");
				add_location(ul0, file, 180, 8, 5721);
				attr_dev(ul1, "class", "calendar-days svelte-179heku");
				add_location(ul1, file, 185, 8, 5890);
				attr_dev(div1, "class", "calendar-view svelte-179heku");
				add_location(div1, file, 179, 4, 5684);
				attr_dev(div2, "class", "calendar-container svelte-179heku");
				attr_dev(div2, "data-theme", /*theme*/ ctx[0]);
				add_location(div2, file, 147, 0, 4562);
			},
